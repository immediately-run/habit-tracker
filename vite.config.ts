...
//
// __APP_DEV__ replaces `import.meta.env.DEV` in app code: the sandbox transpiler
// cannot parse `import.meta`, so src/lib/store.ts branches on this define instead.
